...
export function buildAnalysisContextFromMetadata({ metadata, url, userInputs = {} }) {
  ...
  console.log('[YouTube Extract]', {
    ...
    availableCaptionLanguages: metadata?.availableCaptionLanguages || [],
    selectedCaptionLanguage: metadata?.selectedCaptionLanguage || null,
    captionTextLength: extractedTranscript.length,
    transcriptLength: extractedTranscript.length,
  ...
  logVideoExtractPipeline({
    ...
    title,
    description: extractedDescription,
    captionText: extractedCaption || extractedTranscript,
  ...
  return {
    ...
    availableCaptionLanguages: metadata?.availableCaptionLanguages || [],
    selectedCaptionLanguage: metadata?.selectedCaptionLanguage || null,
    captionFetchError: metadata?.captionFetchError || null,
    autoExtractFailed,
